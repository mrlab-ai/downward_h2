...
public:
    ...
    */
    ...
    virtual EvaluationResultBatched compute_result(EvaluationContextBatched &eval_context);
    ...
    void report_new_minimum_value(const EvaluationResultBatched &result, int i) const;
