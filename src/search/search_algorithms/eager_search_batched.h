#ifndef SEARCH_ALGORITHMS_EAGER_SEARCH_BATCHED_H
#define SEARCH_ALGORITHMS_EAGER_SEARCH_BATCHED_H
...
class EagerSearchBatched : public SearchAlgorithm {
    ...
    void update_f_value_statistics(EvaluationContextBatched &eval_context);
