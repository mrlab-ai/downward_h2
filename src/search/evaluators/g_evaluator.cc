...
EvaluationResultBatched GEvaluator::compute_result(EvaluationContextBatched &eval_context) {
    EvaluationResultBatched result = EvaluationResultBatched();
    result.set_evaluator_values(eval_context.get_g_values());
    return result;
}
