#ifndef EVALUATION_CONTEXT_BATCHED_H
#define EVALUATION_CONTEXT_BATCHED_H
...
class EvaluationContextBatched {
    EvaluatorCacheBatched cache;
    ...
    EvaluationContextBatched(
        const EvaluatorCacheBatched &cache, const State &state, int g_value,
...
public:
    ...
    */
    EvaluationContextBatched(
        const EvaluationContextBatched &other,
    ...
    */
    EvaluationContextBatched(
        const State &states, int g_value, bool is_preferred,
    ...
    */
    ...
    EvaluationResultBatched &get_result(Evaluator *eval); //no reference -> veeeery slow
    EvaluationResultBatched &get_result(Evaluator *eval, int idx); //no reference -> veeeery slow
    const EvaluatorCacheBatched &get_cache() const;
    ...
    */
    std::vector<bool> is_evaluator_value_infinite(Evaluator *eval);
    bool is_evaluator_value_infinite(Evaluator *eval, int idx);
    std::vector<int> get_evaluator_value(Evaluator *eval);
    std::vector<int> get_evaluator_value_or_infinity(Evaluator *eval);
